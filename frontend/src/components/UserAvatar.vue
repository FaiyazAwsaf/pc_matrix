  ...
  <div class="user-avatar">
    <div class="relative">
      ...
      >
        ...
        <div 
          v-else 
          class="w-full h-full bg-blue-600 flex items-center justify-center text-white font-semibold text-sm"
        >
          {{ getInitials() }}
        </div>
      </div>
      ...
      <div 
        v-if="showDropdown" 
        class="surface-panel absolute right-0 mt-2 w-64 z-50 overflow-hidden"
        @click.stop
      >
        <!-- User Info Section -->
        ...
        <div class="py-1">
          <button
            @click="goToProfile"
            class="flex items-center w-full px-4 py-2 text-sm font-semibold text-neutral-700 hover:bg-beige-50 transition-colors"
          >
